...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[60vh] sm:min-h-[70vh] lg:min-h-[80vh] overflow-hidden bg-primary">
      ...
      {/* Content */}
      <div className="relative z-10 h-full flex items-end justify-center pb-2 sm:pb-3 lg:pb-4 pt-8 sm:pt-12 lg:pt-16">
        <div className="container mx-auto px-4">
          <div className="max-w-full sm:max-w-2xl lg:max-w-3xl mx-auto text-center" style={{ perspective: "1000px" }}>
            ...
            <motion.div 
              className="flex flex-col xs:flex-row justify-center gap-3 sm:gap-4 mb-20 sm:mb-24"
